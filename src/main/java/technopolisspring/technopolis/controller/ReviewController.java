...
public class ReviewController extends AbstractController {
    ...
    public List<ReviewOfUserDto> getReviewsOfUser(HttpSession session, @PathVariable int pageNumber) {
        UserWithoutPasswordDto user = checkIfUserIsLogged(session);
    ...
    @GetMapping("products/{productId}/reviews/page/{pageNumber}")
    public List<Review> getReviewsOfProduct(@PathVariable long productId, @PathVariable int pageNumber){
        return reviewDao.getReviewsOfProduct(productId, validatePageNumber(pageNumber));
    }
